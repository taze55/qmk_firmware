 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | Lock |LG(W) |      |LG(@) |CtPgUp|                    | Home |   {  |   }  | F13  | F11  |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |SSClip|LShift| LGUI | LAlt |CtPgDn|-------.    ,-------| Left | Down |  UP  |Right | F12  |RG(S) |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |SSFile|      |LG(C) |LG(V) |      |-------|    |-------| End  |   [  |   ]  | CF16 | F14  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      |      |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
...
[_LOWER] = LAYOUT(
  ...
  _______, G(C(KC_Q))   , LGUI(KC_W), _______   , LGUI(KC_AT), LCTL(KC_PGUP),                   KC_HOME, KC_LCBR, KC_RCBR, KC_F13      , KC_F11, _______   ,
  _______, G(C(S(KC_4))), KC_LSFT   , KC_LGUI   , KC_LALT    , LCTL(KC_PGDN),                   KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT    , KC_F12, RGUI(KC_S),
  _______, G(S(KC_4))   , _______   , LGUI(KC_C), LGUI(KC_V) , _______      , _______, _______, KC_END , KC_LBRC, KC_RBRC, LCTL(KC_F16), KC_F14, _______   ,
...
[_RAISE] = LAYOUT(
  ...
  LALT(KC_TAB), _______, KC_TILD, KC_LPRN, KC_RPRN, KC_GRV,                    _______, RCS(KC_INS),   RSFT(KC_INS),  KC_F17, _______,               _______,
