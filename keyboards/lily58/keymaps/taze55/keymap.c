 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | Lock |LG(W) |      |LG(@) |CtPgUp|                    | Home |   {  |   }  |CSF16 | F11  |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |SSClip|LShift| LGUI | LAlt |CtPgDn|-------.    ,-------| Left | Down |  UP  |Right | F12  |RG(S) |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |SSFile|      |LG(C) |LG(V) |      |-------|    |-------| End  |   [  |   ]  |ASINS | CINS |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      |      |      |    ※CSINSも兼ねる(VSCodeなどで)
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
...
[_LOWER] = LAYOUT(
  ...
  _______, G(C(KC_Q))   , LGUI(KC_W), _______   , LGUI(KC_AT), LCTL(KC_PGUP),                   KC_HOME, KC_LCBR, KC_RCBR, RCS(KC_F16) , KC_F11,       _______   ,
  _______, G(C(S(KC_4))), KC_LSFT   , KC_LGUI   , KC_LALT    , LCTL(KC_PGDN),                   KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT    , KC_F12,       RGUI(KC_S),
  _______, G(S(KC_4))   , _______   , LGUI(KC_C), LGUI(KC_V) , _______      , _______, _______, KC_END , KC_LBRC, KC_RBRC, RSA(KC_INS) , RCTL(KC_INS), _______   ,
 ...
 * |------+------+------+------+------+------.                    ,------+------+------+------+------+------|
 * |AltTab|      |   ~  |   (  |   )  |   `  |                    |      | AF16 |ASF16 | AINS |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |   =  |   "  |   '  |-------.    ,-------|      |CtPgDn|CtPgUp| F16  | CTRL |      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |   \  |   |  |   +  |   -  |   _  |-------|    |-------|      | CF16 |CAF16 | INS  |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |      |      |      | /       /       \      \  |      |      |      | ※このF16の入力ソース切り替えは組み合わせにするとなぜかqmk_firmwareが2回反応して戻されることがある？
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_RAISE] = LAYOUT(
  KC_PSCR     , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,                   KC_F6  , KC_F7        , KC_F8        , KC_F9       ,  KC_F10              , _______,
  LALT(KC_TAB), _______, KC_TILD, KC_LPRN, KC_RPRN, KC_GRV ,                   _______, LALT(KC_F16) , RSA(KC_F16)  , LALT(KC_INS), _______              , _______,
  _______     , _______, _______, KC_EQL , KC_DQT , KC_QUOT,                   _______, LCTL(KC_PGDN), LCTL(KC_PGUP), KC_F16      , LM(_QWERTY2,MOD_LCTL), _______,
  _______     , KC_BSLS, KC_PIPE, KC_PLUS, KC_MINS, KC_UNDS, _______, _______, _______, LCTL(KC_F16) , LCA(KC_F16)  , KC_INS      , _______              , _______,
                                  _______, _______, _______, _______, _______, _______, _______      , _______
),
